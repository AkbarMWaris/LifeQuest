...
const variants = {
  primary:
    'bg-gradient-to-b from-arcane-400 to-arcane-600 text-void-950 border border-arcane-300/40 shadow-glow hover:from-arcane-300 hover:to-arcane-500',
  ...
  ghost: 'bg-transparent text-slate-300 border border-slate-50/10 hover:border-arcane-400/40 hover:text-white hover:bg-arcane-500/10',
  danger: 'bg-gradient-to-b from-rose-400 to-rose-600 text-white border border-rose-300/30 hover:from-rose-300 hover:to-rose-500',
